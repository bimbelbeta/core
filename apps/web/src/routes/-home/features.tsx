...
function FeatureTwo() {
	return (
		<div className="relative h-70 w-full rounded-xl border border-neutral-200 bg-linear-to-t from-neutral-100 via-66% via-primary-100 to-primary-300/80 p-5 text-center md:mx-0 md:max-w-none md:p-6 min-[490px]:mx-auto min-[490px]:max-w-[420px]">
			<Subheading>
				Simulasi{" "}
				<span className="font-semibold text-primary-900">UTBK & Ranking</span> Nasional{" "}
				<span className="font-semibold text-primary-900">Feedback</span> Instan!
			</Subheading>
			<p className="text-sm">Ukur kesiapanmu lewat Tryout terjadwal.
Cek posisimu di antara pesaing dari seluruh sekolah.</p>
...
function FeatureThree() {
	return (
        ...
        <span className="font-semibold text-primary-900">Materi Video & Modul</span>{' '}yang Terstruktur Rapi
			...
			<p className="text-sm md:max-w-xs md:mt-2">Tak perlu bingung mulai dari mana. Akses video teori dan rangkuman yang disusun urut per topik dalam satu dashboard.</p>
