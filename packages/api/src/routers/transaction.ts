...
const subscribe = authed.transaction.subscribe.handler(
	async ({ input, context, errors }: HandlerOptions<typeof authed.transaction.subscribe>) => {
...
const notification = pub.transaction.notification.handler(
	async ({ input }: HandlerOptions<typeof pub.transaction.notification>) => {
...
const status = authed.transaction.status.handler(
	async ({ input, errors }: HandlerOptions<typeof authed.transaction.status>) => {
