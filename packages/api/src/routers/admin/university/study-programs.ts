...
const list = admin.admin.university.studyPrograms.list.handler(async ({ input }: HandlerOptions<typeof admin.admin.university.studyPrograms.list>) => {
...
const find = admin.admin.university.studyPrograms.find.handler(async ({ input }: HandlerOptions<typeof admin.admin.university.studyPrograms.find>) => {
...
const create = admin.admin.university.studyPrograms.create.handler(async ({ input }: HandlerOptions<typeof admin.admin.university.studyPrograms.create>) => {
...
const update = admin.admin.university.studyPrograms.update.handler(async ({ input }: HandlerOptions<typeof admin.admin.university.studyPrograms.update>) => {
	const updateData: {
		name?: string;
		slug?: string;
...
const remove = admin.admin.university.studyPrograms.remove.handler(async ({ input }: HandlerOptions<typeof admin.admin.university.studyPrograms.remove>) => {
